...
class StringsTest(unittest.TestCase):
    ...
    def test_contains_with_matching_patterns(self):
        ...
        # My test cases
        assert contains('yolo', 'yo') is True
        assert contains("y'all", 'all') is True
        assert contains('yoyo', 'oy') is True
    ...
    def test_contains_with_non_matching_patterns(self):
        ...
        # My test cases
        assert contains('git', 'gti') is False
        assert contains('this is a really cool sentence', 'this is not') is False
        assert contains('poopoo', 'peepee') is False
    ...
    def test_find_index_with_matching_patterns(self):
        ...
        # My test cases
        assert find_index('eaeaeatinggngnngn', 'eating') == 4
        assert find_index('hello?!? hello!?? hello !..?', 'hello!') == 9
        assert find_index('this is so tedious', 's so te') == 6
    ...
    def test_find_index_with_complex_patterns(self):
        ...
        # My test cases
        assert find_index('ughh ughughhh ughhh ughhh', 'ughhh') == 8
        assert find_index('...!...', '!') == 3
        assert find_index('?>?>?>', '>?>') == 1
    ...
    def test_find_all_indexes_with_matching_patterns(self):
        ...
        # My test cases
        assert find_all_indexes('duckduckgo', 'duck') == [0, 4]
        assert find_all_indexes('accckckckacckac', 'cc') == [1, 2, 10]
        assert find_all_indexes('i, um, umm, so, ugh,,,', ',') == [1, 5, 10, 14, 19, 20, 21]
    ...
    def test_find_all_indexes_with_non_matching_patterns(self):
        ...
        # My test cases
        assert find_all_indexes('heyyyo', 'oyyyeh') == []
        assert find_all_indexes('t est', 'test') == []
        assert find_all_indexes('te!st', 'test') == []
    ...
    def test_find_all_indexes_with_complex_patterns(self):
        ...
        # My test cases
        assert find_all_indexes('uhghughgughguhguhg', 'ugh') == [4, 8]
        assert find_all_indexes('idk idk idk idk', 'idk ') == [0, 4, 8]
        assert find_all_indexes('a.b.c.d...e?/.sf..321.', '.') == [1, 3, 5, 7, 8, 9, 13, 16, 17, 21]
